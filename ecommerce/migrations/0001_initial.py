    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delivery_status', models.CharField(choices=[('pending', 'Pending'), ('processing', 'Processing'), ('delivered', 'Delivered')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('about', 'About'), ('refund', 'Refund'), ('privacy', 'Privacy'), ('terms', 'Terms')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('remark', models.CharField(choices=[('popular', 'Popular'), ('new', 'New'), ('top', 'Top'), ('special', 'Special')], max_length=20)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
